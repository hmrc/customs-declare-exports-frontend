...
trait LocationOfGoodsMessages {
  ...
  val identOfLocationEmpty: String = locationOfGoods + ".identificationOfLocation.empty"
  ...
  val additionalIdentifierEmpty: String = locationOfGoods + ".additionalIdentifier.empty"

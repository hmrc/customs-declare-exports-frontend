...
trait CommodityMeasureMessages {

  val commodityMeasure: String = "supplementary.commodityMeasure"
  ...
  val supplementaryUnits: String = commodityMeasure + ".supplementaryUnits"
  val supplementaryUnitsHint: String = commodityMeasure + ".supplementaryUnits.hint"
  val supplementaryUnitsError: String = commodityMeasure + ".supplementaryUnits.error"
}

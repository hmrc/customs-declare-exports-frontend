...
class PointerRecordSpec extends UnitViewSpec with ExportsTestHelper with Injector {
  ...
  "PointerRecord" can {
    "find a record for the following pointers" in {
      ...
      validatePointerValues("declaration.parties.declarationHolders.holders.$.authorisationTypeCode", CSE.toString, 0)
      ...
      validatePointerValues("declaration.previousDocuments.documents.$.documentCategory", None, None, 0)

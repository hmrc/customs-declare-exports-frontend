...
import forms.journey.JourneySelection.nonStandardJourneys
...
@ViewTest
class OtherJourneyViewSpec extends UnitViewSpec with CommonMessages with Injector {

  private val form: Form[String] = JourneySelection.form(nonStandardJourneys)
  private val page = instanceOf[other_journey]

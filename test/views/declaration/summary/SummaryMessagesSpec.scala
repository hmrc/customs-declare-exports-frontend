...
class SummaryMessagesSpec extends UnitViewSpec {
  ...
  "Summary page" should {
    ...
    "have defined parties messages" in {
      ...
      messages must haveTranslationFor("declaration.summary.parties.additional.type")
      messages must haveTranslationFor("declaration.summary.parties.additional.eori")
      messages must haveTranslationFor("declaration.summary.parties.additional.CS")
      messages must haveTranslationFor("declaration.summary.parties.additional.MF")
      messages must haveTranslationFor("declaration.summary.parties.additional.FW")
      messages must haveTranslationFor("declaration.summary.parties.additional.WH")

...
@ViewTest
class NactCodeAddViewSpec extends UnitViewSpec with ExportsTestData with Stubs with MustMatchers with CommonMessages with Injector {
  ...
  "Nact Code Add View" should {
    ...
    "display page title" in {
      view.getElementsByTag("h1").text() must be(realMessages("declaration.nationalAdditionalCode.addnext.header"))
    }

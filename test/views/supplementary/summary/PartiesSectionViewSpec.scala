...
package views.supplementary.summary
...
import models.declaration.supplementary.{DeclarationHoldersData, Parties}
import play.twirl.api.Html
import views.html.supplementary.summary.parties_section

...
object Stubs {
  ...
  val baseConfig: String =
    """
      |features.choicePageMaintenanceBanner = true
      |features.optionalFields = false
      ...
      |
      |choicePageMaintenanceBanner.from = "2025-02-26T23:01Z"
      |choicePageMaintenanceBanner.to = "2025-02-27T02:30Z"
      """.stripMargin

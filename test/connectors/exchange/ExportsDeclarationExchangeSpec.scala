...
class ExportsDeclarationExchangeSpec extends WordSpec with Matchers with ExportsDeclarationBuilder with MockitoSugar {
  ...
  "Request" should {
    ...
    "bindable by version1 of payload" in {
      Json
        .parse(ExportsDeclarationExchangeSpec.declarationVersion1)
        .validate[ExportsDeclarationExchange] shouldBe a[JsSuccess[_]]
    }

    "bindable by version2 of paylaod" in {
      Json
        .parse(ExportsDeclarationExchangeSpec.declarationVersion2)
        .validate[ExportsDeclarationExchange] shouldBe a[JsSuccess[_]]
    }

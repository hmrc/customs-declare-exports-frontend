...
class SubmissionsControllerSpec extends ControllerWithoutFormSpec with MockExportCacheService with BeforeAndAfterEach {
  ...
  private val submittedDeclaration = mock[submitted_declaration]
  ...
  override protected def afterEach(): Unit = {
    reset(submittedDeclaration, mockCustomsDeclareExportsConnector, paginationConfig, mockErrorHandler)
    super.afterEach()
  }

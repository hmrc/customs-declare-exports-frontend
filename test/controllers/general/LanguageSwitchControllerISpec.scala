...
import controllers.general.routes.LanguageSwitchController
...
class LanguageSwitchControllerSpec extends ConnectorISpec with OptionValues {
  ...
  private def switchLanguageRoute(lang: String): String = LanguageSwitchController.switchToLanguage(lang).url

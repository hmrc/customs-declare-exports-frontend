...
import forms.section6.ModeOfTransportCode.{meaningfulModeOfTransportCodes, Maritime, RoRo}
import forms.section6.{BorderTransport, ModeOfTransportCode, TransportLeavingTheBorder}

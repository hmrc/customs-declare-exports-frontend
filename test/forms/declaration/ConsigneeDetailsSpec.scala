...
class ConsigneeDetailsSpec extends WordSpec with MustMatchers {
  ...
  "Method toMetadataProperties" should {
    "map correctly" in {
      ...
      metadata.declaration.get.goodsShipment.get.consignee mustBe defined
      metadata.declaration.get.goodsShipment.get.consignee.get.id mustBe defined
      metadata.declaration.get.goodsShipment.get.consignee.get.id.get must be(consigneeDetails.details.eori.get)
      metadata.declaration.get.goodsShipment.get.consignee.get.name mustBe defined
      metadata.declaration.get.goodsShipment.get.consignee.get.name.get must be(
        consigneeDetails.details.address.get.fullName
      )
      metadata.declaration.get.goodsShipment.get.consignee.get.address mustBe defined
      metadata.declaration.get.goodsShipment.get.consignee.get.address.get.line mustBe defined
      ...
      metadata.declaration.get.goodsShipment.get.consignee.get.address.get.cityName mustBe defined
      ...
      metadata.declaration.get.goodsShipment.get.consignee.get.address.get.postcodeId mustBe defined
      ...
      metadata.declaration.get.goodsShipment.get.consignee.get.address.get.countryCode mustBe defined

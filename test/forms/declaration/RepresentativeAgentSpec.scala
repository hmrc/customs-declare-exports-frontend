  ...
  "RepresentativeAgent mapping used for binding data" should {
    ...
    "return form with errors" when {
      ...
      "provided with unrecognized response" in {
        val form = RepresentativeAgent.form().bind(representativeAgentJSON("invalid"))
      ...
      "provided with missing response" in {
        val form = RepresentativeAgent.form().bind(representativeAgentJSON(""))
    ...
    "return form without errors" when {
      "provided with valid response" in {
        val form = RepresentativeAgent.form().bind(representativeAgentJSON(yes))

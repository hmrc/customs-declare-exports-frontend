...
object AppConfigSpec {
  val configBareMinimum =
    """
      ...
      |guidance.additionalDeclarationType = "https://www.gov.uk/government/publications/uk-trade-tariff-cds-volume-3-export-declaration-completion-guide/group-1-message-information-including-procedure-codes#de-12-additional-declaration-type-box-1-declaration-second-subdivision"
      ...
      |guidance.simplifiedDeclarationOccasionalUse = "https://www.gov.uk/government/publications/appendix-2-de-111-additional-procedure-codes/additional-procedure-code-3-series"

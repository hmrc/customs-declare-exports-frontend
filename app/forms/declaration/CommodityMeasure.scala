...
object CommodityMeasure {
  ...
  val mapping = Forms.mapping(
    "supplementaryUnits" -> optional(
      text().verifying("supplementary.commodityMeasure.supplementaryUnits.error", validateDecimalGreaterThanZero(17)(7) and containsNotOnlyZeros)
    ),
    "grossMass" -> text
      .verifying("supplementary.commodityMeasure.grossMass.empty", nonEmpty)
      .verifying("supplementary.commodityMeasure.grossMass.error", isEmpty or validateDecimalGreaterThanZero(17)(7) and containsNotOnlyZeros),
    "netMass" -> text
      .verifying("supplementary.commodityMeasure.netMass.empty", nonEmpty)
      .verifying("supplementary.commodityMeasure.netMass.error", isEmpty or validateDecimalGreaterThanZero(17)(7) and containsNotOnlyZeros)

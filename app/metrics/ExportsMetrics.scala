...
class ExportsMetrics @Inject() (metrics: Metrics) {
  ...
  private val timers: Map[String, Timer] = List(submissionMetric, submissionAmendmentMetric, cancellationMetric)
  ...
  private val counters: Map[String, Counter] = List(submissionMetric, submissionAmendmentMetric, cancellationMetric)

...
class Guidance(
  ...
  val additionalDeclarationType: String,
  val aiCodes: String,
  ...
  val declareGoodsExported: String,
  val eoriService: String,
  val exportingByPost: String,
  val simplifiedDeclarationOccasionalUse: String,
...
object Guidance {
  def apply(loadConfig: String => String): Guidance =
    new Guidance(
      ...
      additionalDeclarationType = loadConfig("guidance.additionalDeclarationType"),
      ...
      declareGoodsExported = loadConfig("guidance.declareGoodsExported"),
      ...
      simplifiedDeclarationOccasionalUse = loadConfig("guidance.simplifiedDeclarationOccasionalUse"),
